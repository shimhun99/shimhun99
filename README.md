...
백엔드 개발로 시작해서 현재는 서비스를 효율적이고 안정적으로 운영하는데 필요한 **클라우드 네이티브 기술**에 많은 관심을 가지고 있습니다.  

매달 지출되던 서비스 운영 비용을 줄이기 위해 GCP 기반 서비스를 온프레미스 홈서버 환경으로 전환한 경험은, 특정 기술에 종속되지 않고 상황에 따라 유연하게 대처하는 제 강점을 잘 보여줍니다.
